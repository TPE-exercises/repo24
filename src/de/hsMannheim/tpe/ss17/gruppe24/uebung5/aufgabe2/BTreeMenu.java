...
public class BTreeMenu {
	...
	static BTree<Integer>[] workingTree;
	...
	public static void main(String[] args) {
		...
		workingTree[0] = new BTree<Integer>(1);
		workingTree[1] = new BTree<Integer>(1);
		workingTree[2] = new BTree<Integer>(1);
	...
	public static void makeMenu() {
		...
		case 1:
			...
			workingTree[treeIndex] = new BTree<Integer>(readInt());
			break;
		case 2:
		...
		case 7:
			if (workingTree[treeIndex] != null) {
				Integer max = (Integer) workingTree[treeIndex].getMax();
		...
		case 8:
			if (workingTree[treeIndex] != null) {
				Integer min = (Integer) workingTree[treeIndex].getMin();
		...
		case 17:			
			for(Integer i : workingTree[treeIndex]){
